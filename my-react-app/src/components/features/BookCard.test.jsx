...
describe('BookCard Component', () => {
  ...
  test('отображает информацию о книге', () => {
    ...
    expect(screen.getByTestId('mock-status')).toHaveTextContent('Status: Available');
  });
  ...
  test('обрабатывает клик по кнопке Details', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Details clicked for: Test Driven Development');
